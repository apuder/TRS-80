...
public class Key extends View {
    ...
    final public static int TK_AT               = 66;
    final public static int TK_LEFT             = 67;
    final public static int TK_RIGHT            = 68;
    final public static int TK_DOWN             = 69;
    final public static int TK_ALT              = 70;
